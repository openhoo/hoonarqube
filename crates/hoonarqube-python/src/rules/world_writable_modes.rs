...
pub(crate) fn check_world_writable_modes(
    ...
    for call in &file_ctx.calls {
        ...
        let (position, safe_modulo) = if matches!(
            path_str,
            Some("os.chmod" | "os.fchmod" | "os.lchmod")
...
fn is_unsafe_mode(
    ...
    match expr {
        ...
        Expr::NumberLiteral(_) => int_literal_value(expr)
            .is_some_and(|value| value % 8 != safe_modulo),
