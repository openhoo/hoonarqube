...
pub(crate) fn check_tier_a_battery(
    ...
    issues.extend(check_wildcard_imports(
        parsed, index, source, file_ctx, path,
    ));
...
/// Aggregates the future-reference detectors (python:S8502, python:S8510,
/// python:S8513, python:S8517–S8521, python:S8554, python:S8572,
/// python:S8714, python:S8786) added ahead of their catalog entries;
/// S8518–S8554 and S8786 read the shared statement/expression inventories.
