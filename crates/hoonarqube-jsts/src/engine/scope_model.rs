...
use crate::support::{
    IssueSink, RuleScope, binding_identifier_name, identifier_name, member_object, source_slice,
...
use oxc_ast::ast::{
    ...
    Function, IfStatement, ImportDeclaration, ImportDeclarationSpecifier, MemberExpression,
    MethodDefinition, MethodDefinitionKind, ModuleExportName, NewExpression, ReturnStatement,
    SimpleAssignmentTarget, Statement, StaticBlock, SwitchStatement, ThrowStatement, TryStatement,
    UnaryExpression, UnaryOperator, UpdateExpression, VariableDeclaration, VariableDeclarationKind,
