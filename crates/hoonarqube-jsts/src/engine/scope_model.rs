...
use oxc_ast::ast::{Argument, ArrayExpression, ArrowFunctionBody, ArrowFunctionExpression, AssignmentExpression, AssignmentOperator, AssignmentTarget, BinaryExpression, BinaryOperator, BindingIdentifier, BindingPattern, BlockStatement, BreakStatement, CallExpression, CatchClause, Class, ConditionalExpression, ContinueStatement, Declaration, DoWhileStatement, ExportDefaultDeclarationKind, ExportSpecifier, Expression, ForInStatement, ForOfStatement, ForStatement, ForStatementLeft, FormalParameters, Function, FunctionBody, IfStatement, ImportDeclaration, ImportDeclarationSpecifier, ImportSpecifier, MemberExpression, MethodDefinition, MethodDefinitionKind, ModuleExportName, NewExpression, NumericLiteral, ObjectExpression, RegExpLiteral, ReturnStatement, SimpleAssignmentTarget, Statement, StaticBlock, StringLiteral, SwitchStatement, TemplateLiteral, ThrowStatement, TryStatement, UnaryExpression, UnaryOperator, UpdateExpression, VariableDeclaration, VariableDeclarationKind, VariableDeclarator, WhileStatement};
use oxc_ast_visit::{Visit};
use oxc_ast_visit::walk::{walk_arrow_function_expression, walk_binary_expression, walk_block_statement, walk_call_expression, walk_catch_clause, walk_class, walk_declaration, walk_export_default_declaration, walk_expression, walk_for_in_statement, walk_for_of_statement, walk_for_statement, walk_function, walk_method_definition, walk_new_expression, walk_program, walk_return_statement, walk_static_block, walk_switch_statement, walk_unary_expression, walk_variable_declaration, walk_variable_declarator};
use oxc_span::{GetSpan, Span};
use oxc_syntax::scope::{ScopeFlags};
use std::collections::{BTreeMap, BTreeSet, HashMap};
use crate::support::{IssueSink, RuleScope, binding_identifier_name, identifier_name, member_object, source_slice, static_property_name, unparenthesized};
...
pub(crate) fn tb_assignment_target<'data>(target: &AssignmentTarget<'data>) -> Option<(&'data str, Span)> {
    match target {
