...
use oxc_ast::ast::{Argument, Class, Expression, RegExpFlags, RegExpLiteral, StringLiteral, TemplateLiteral};
...
impl PatternParser<'_> {
    ...
    pub(crate) fn parse_sequence(&mut self, terminator: Option<char>) -> Result<Vec<PatternNode>, ()> {
...
pub(crate) fn constructor_regex_site(arguments: &[oxc_ast::ast::Argument<'_>]) -> Option<RegexSite> {
