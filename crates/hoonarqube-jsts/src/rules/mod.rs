...
mod s7755_prefer_at;
mod s7763_prefer_export_from;
mod s7765_prefer_includes;
mod s7766_prefer_math_min_max;
mod s7767_prefer_math_trunc;
...
pub(crate) fn run_all(ctx: &AnalysisContext) -> Vec<Issue> {
    ...
    issues.extend(s7763_prefer_export_from::check(ctx));
    issues.extend(s7765_prefer_includes::check(ctx));
    issues.extend(s7766_prefer_math_min_max::check(ctx));
    issues.extend(s7767_prefer_math_trunc::check(ctx));
