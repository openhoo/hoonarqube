...
use oxc_ast::ast::{AssignmentTarget, BindingIdentifier, BindingPattern, CallExpression, Expression, ExpressionStatement, MemberExpression, ModuleExportName, NewExpression, ParenthesizedExpression, PropertyKey, SimpleAssignmentTarget, Statement, StringLiteral, UpdateExpression};
...
pub(crate) fn statement_as_expression<'a>(statement: &'a Statement<'a>) -> Option<&'a Expression<'a>> {
    match statement {
