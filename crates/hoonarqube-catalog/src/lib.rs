...
mod tests {
    ...
    /// Adds-only supplements layered after the base captures: eighteen
    /// javascript, twenty-two typescript, and eighteen python keys from
    /// verified community captures.
    const SUPPLEMENT_RULES: usize = 58;
