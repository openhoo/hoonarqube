...
mod tests {
    ...
    /// Adds-only supplements layered after the base captures: twenty-seven
    /// javascript, thirty-one typescript, and eighteen python keys from
    /// verified community captures.
    const SUPPLEMENT_RULES: usize = 76;
