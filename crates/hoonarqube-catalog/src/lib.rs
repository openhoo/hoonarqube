...
mod tests {
    ...
    /// Adds-only supplements layered after the base captures: sixteen
    /// javascript, twenty typescript, and seventeen python keys from
    /// verified community captures.
    const SUPPLEMENT_RULES: usize = 53;
