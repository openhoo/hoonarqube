...
mod tests {
    ...
    /// Adds-only supplements layered after the base captures: twenty-eight
    /// javascript, thirty-two typescript, and eighteen python keys from
    /// verified community captures.
    const SUPPLEMENT_RULES: usize = 78;
