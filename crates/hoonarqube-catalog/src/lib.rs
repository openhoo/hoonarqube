...
mod tests {
    ...
    /// Adds-only supplements layered after the base captures: twenty
    /// javascript, twenty-four typescript, and eighteen python keys from
    /// verified community captures.
    const SUPPLEMENT_RULES: usize = 62;
