...
const OWNER = 'openhoo';
const REPO = 'hoonarqube';
const ISSUE_NUMBER = 314;
const TIMELINE_BASE = Date.parse('2026-09-11T12:00:00.000Z');
const NEEDS_INFO_MARKER = '<!-- hoonarqube-issue-intake:v1 needs-info-owned=true -->';
const RESOLVED_MARKER = '<!-- hoonarqube-issue-intake:v1 needs-info-owned=false -->';
